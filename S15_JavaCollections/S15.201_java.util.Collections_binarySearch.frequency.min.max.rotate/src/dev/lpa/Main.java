...
//        binarySearch method on collections (example below), is over-loaded like the sort method,
...
//        frequency method (example below), is used to check for duplicates in my collection:
...
//        rotate method (example below), moves the last two elements of the list to the first two elements.
//        A POSITIVE number moves the elements from the back to the front. Notice that the order is maintained
//        in the list, meaning 'Q' is still before 'K'.
...
//        Using a NEGATIVE number moves the first two elements of the list to the last two numbers of the list.
...
//        swap method (example below), only requires swapping HALF the elements:
